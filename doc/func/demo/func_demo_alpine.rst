Module func_demo_alpine: Alpine function for demo and tests
-----------------------------------------------------------


.. automodule:: teneva.func.demo.func_demo_alpine
...
.. code-block:: python
  ...
  func = teneva.FuncDemoAlpine(d=100)
...
.. code-block:: python
  ...
  # Alpine          [CORES        ] > error: 2.8e-16 | rank:  2.0 | time:   0.137
  # 
...
.. code-block:: python
  ...
  func = teneva.FuncDemoAlpine(d=10)
