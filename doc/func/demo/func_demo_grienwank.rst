Module func_demo_grienwank: Grienwank function for demo and tests
-----------------------------------------------------------------


.. automodule:: teneva.func.demo.func_demo_grienwank
...
.. code-block:: python
  ...
  func = teneva.FuncDemoGrienwank(d=100)
...
.. code-block:: python
  ...
  # Grienwank       [CORES        ] > error: 3.0e-16 | rank:  3.0 | time:   0.216
  # 
...
.. code-block:: python
  ...
  func = teneva.FuncDemoGrienwank(d=10)
